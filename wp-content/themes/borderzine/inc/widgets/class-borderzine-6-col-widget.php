...
/**
 * Borderzine 6-Column recent posts widget and associated functions
 *
 * Copied from Largo Recent Posts
 */
class Borderzine_6_Col_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			'classname' => 'borderzine-6-col-widget',
			'description' => __( 'A flexible widget to display recent photo gallery posts.', 'borderzine' )
		);
		parent::__construct(
			'borderzine-6-col-widget', // Base ID
			__( 'Borderzine 6 Column Widget', 'borderzine' ), // Name
			$widget_ops // Args
		);
...
add_action( 'widgets_init', function() {
	register_widget( 'Borderzine_6_Col_Widget' );
});